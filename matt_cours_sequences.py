...
# %%
######## OPERATEUR []: lire les éléments d'une séquence à l'index i
...
# %%
######## SLICING: trouver une sous-séquence
# 10 => 'u', 17 => ' '
...
# %%
######## OPERATEUR IN: savoir si un élément existe dans une séquence
...
# %%
######## ACTIONS MUTABLES: ajouter des éléments dans une liste
# liste vide, str vide => "", tuple vide ()
mots = []
# IndexError: on ne peut pas créer les indices
# mots[0] = "appeler"
...
# %%
######## ACTIONS MUTABLES: enlever des éléments
# à la fin ET retourne l'élément supprimé
print(mots.pop())
# à gauche
mots.pop(0)
print(mots)

# enlever l'élément de 1ère occurence d'une valeur
mots.remove("un")
mots
...
dicton = "appeler un chat un chat"
# str.split() => liste de mots séparés par un " "
mots = dicton.split()
print(mots)
